...
fetch-depth: 0
      ...
      - name: Lint
        run: npx turbo@latest run lint --filter=web --filter=chrome-extension --filter=docs --filter=e2e --filter=@repo/ui

      - name: Type Check
        run: npx turbo@latest run check-types --filter=web --filter=chrome-extension --filter=docs --filter=e2e --filter=@repo/ui

      - name: Build
        run: npx turbo@latest run build --filter=web --filter=chrome-extension --filter=docs --filter=e2e --filter=@repo/ui

      - name: Test
        run: npx turbo@latest run test --filter=web --filter=chrome-extension --filter=docs --filter=@repo/ui
      ...
      - name: Run Playwright tests
        run: npx turbo@latest run test --filter=e2e
