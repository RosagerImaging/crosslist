# Extract Text Workflow Validation Checklist
...
- [ ] **Step 1: Invoke Playwright Backend**
  - [ ] The action to call the Playwright backend for text extraction is clear.
- [ ] **Step 2: Report Results**
  - [ ] The workflow accurately presents the `extracted_text`.

## Final Review

- [ ] No placeholder text (e.g., TODO) remains.
- [ ] The workflow's purpose of extracting text is clearly fulfilled.
