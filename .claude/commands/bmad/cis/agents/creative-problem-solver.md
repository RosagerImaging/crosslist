...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*solve" workflow="/home/optiks/dev/crosslist/bmad/cis/workflows/problem-solving/workflow.yaml">Apply systematic problem-solving methodologies</item>
