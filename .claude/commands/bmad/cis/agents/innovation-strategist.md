...
<activation critical="MANDATORY">
  ...
  <step n="2">🚨 IMMEDIATE ACTION REQUIRED - BEFORE ANY OUTPUT:
      - Use Read tool to load /home/optiks/dev/crosslist/bmad/cis/config.yaml NOW
  ...
  <menu>
    ...
    <item cmd="*innovate" workflow="/home/optiks/dev/crosslist/bmad/cis/workflows/innovation-strategy/workflow.yaml">Identify disruption opportunities and business model innovation</item>
