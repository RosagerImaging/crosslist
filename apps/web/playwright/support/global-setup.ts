...
async function globalSetup(config: FullConfig) {
  ...
  await page.fill('[data-testid="email-input"]', process.env.PLAYWRIGHT_TEST_USERNAME || 'test@example.com');
  await page.fill('[data-testid="password-input"]', process.env.PLAYWRIGHT_TEST_PASSWORD || 'password123');
